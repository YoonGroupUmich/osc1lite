    ...
    methods
        ...
        function PopulateWaveformPanels(this, parent, wf)
            ...
            uicontrol('Style', 'text', ...
                ...
                'Parent', parent, 'Position', [.05, .75, .18, .2], 'Background', 'white');
            uicontrol('Style', 'text', ...
                'String', 'Number of Pulses', 'Units', 'normalized', ...
                'Parent', parent, 'Position', [.05, .25, .18, .2], 'Background', 'white');
            uicontrol('Style', 'text', ...
                'String', 'Amplitude (uA)', 'Units', 'normalized', ...
                'Parent', parent, 'Position', [.24, .25, .18, .2], 'Background', 'white');
            uicontrol('Style', 'text', ...
                'String', 'Pulse Width(ms)', 'Units', 'normalized', ...
                'Parent', parent, 'Position', [.43, .25, .18, .2], 'Background', 'white');
            uicontrol('Style', 'text', ...
                'String', 'Period(ms)', 'Units', 'normalized', ...
                'Parent', parent, 'Position', [.61, .25, .18, .2], 'Background', 'white');
            uicontrol('Style', 'text', ...
                'String', 'RiseTime(ms)', 'Units', 'normalized', ...
                'Parent', parent, 'Position', [.81, .25, .18, .2], 'Background', 'white');

            this.WF_pulse_selectors(wf) = uicontrol('Style', 'edit', 'String', '0', 'Units', 'normalized', 'Parent', ...
                parent, 'Position', [.05, .05, .18, .2], 'Background', 'white', 'UserData', struct('wf', wf), 'Callback', @this.PulseSelectCB);
            this.WF_amp_selectors(wf) = uicontrol('Style', 'edit', 'String', '0', 'Units', 'normalized', 'Parent', ...
                parent, 'Position', [.24, .05, .18, .2], 'Background', 'white', 'UserData', struct('wf', wf), 'Callback', @this.AmpSelectCB);
            this.WF_pw_selectors(wf) = uicontrol('Style', 'edit', 'String', '0', 'Units', 'normalized', 'Parent', ...
                parent, 'Position', [.43, .05, .18, .2], 'Background', 'white', 'UserData', struct('wf', wf), 'Callback', @this.PWSelectCB);
            this.WF_period_selectors(wf) = uicontrol('Style', 'edit', 'String', '0', 'Units', 'normalized', 'Parent', ...
                parent, 'Position', [.62, .05, .18, .2], 'Background', 'white', 'UserData', struct('wf', wf), 'Callback', @this.PeriodSelectCB);
            this.WF_risetime_selectors(wf) = uicontrol('Style', 'edit', 'String', '0', 'Units', 'normalized', 'Parent', ...
                parent, 'Position', [.81, .05, .18, .2], 'Background', 'white', 'UserData', struct('wf', wf), 'Callback', @this.RiseTimeSelectCB);
