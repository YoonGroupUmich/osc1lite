classdef OSCGUI < handle
    ...
    methods
        ...
        function TrigOutButtonCB(this, source, eventdata)
            chan = source.UserData.Channel;
            if get(source, 'Value') == 1 % Enable Trigger Out
                this.os.WriteToWireIn(9, chan - 1, 1, 1);
            else
                this.os.WriteToWireIn(9, chan - 1, 1, 0);
            end
        end
